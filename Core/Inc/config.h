...
#define BAT_MAX_VOLTAGE			4095      // Mosfet cutt-off voltage (Raw 0-4095) maximum ADC Value == ~57V on stock M365 ESC <<to prevent a power supply or controller destruction>>
